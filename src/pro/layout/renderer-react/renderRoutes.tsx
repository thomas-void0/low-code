// 渲染路由
import { Redirect, Route as ReactRoute, Switch, SwitchProps } from 'react-router-dom'
...
function render({ route, opts, props }: { route: Route; opts: IOpts; props: any }) {
...
function CreateRoutes(props: { routes?: Route[]; loading?: boolean; switchProps?: SwitchProps }) {
	const { routes, loading, switchProps } = props

	return renderRoutes({ routes: routes!, extraProps: { loading } }, switchProps)
}
